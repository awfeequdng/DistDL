...
LICENSE_TXT = """Copyright 2023 The DistDL Authors. All rights reserved.
...
def get_txt(path: str):
    if path.endswith((".cc", ".h", ".hh", ".cu", ".cuh")):
        return CPP_TXT
...
def check_file(path):
    with open(path, "r", encoding="utf-8") as f:
        ...
        elif content.count("The DistDL Authors. All rights reserved.") > 1:
